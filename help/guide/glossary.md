...
### Attiva (per un collaboratore)

Si riferisce all’azione di invio di un pubblico a un altro collaboratore all’interno di un progetto condiviso. Quando attivi un pubblico per un collaboratore, questo viene inviato alla sua destinazione preconfigurata, dove diventa disponibile per l’utilizzo nelle campagne. Per istruzioni, consulta [Attivare i tipi di pubblico](/help/guide/collaborate/activate.md). Da non confondere con **Attiva (in una destinazione)**.

### Attiva (su una destinazione)

Si riferisce alla destinazione in cui arriva un pubblico attivato, ad esempio una piattaforma di archiviazione cloud o Adobe Experience Platform, e all’area di lavoro in cui vengono configurate, sfogliate e monitorate le destinazioni. I tipi di pubblico raggiungono ancora una destinazione tramite l&#39;azione [Attiva tipi di pubblico](/help/guide/collaborate/activate.md) all&#39;interno di un progetto; questa area di lavoro definisce quali destinazioni sono disponibili e come sono configurate. Per istruzioni, consulta [Panoramica sulle destinazioni](/help/guide/destinations/overview.md). Da non confondere con **Attiva (per un collaboratore)**.

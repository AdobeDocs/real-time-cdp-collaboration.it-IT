...
Per informazioni più complete sui registri di controllo, consulta la [documentazione dei registri di controllo di Adobe Experience Platform](https://experienceleague.adobe.com/it/docs/experience-platform/landing/governance-privacy-security/audit-logs/overview){target="_blank"}.
